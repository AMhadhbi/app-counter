    ...
    render() { 
        return ( 
            <div className="row">
                ...
                <div className="col">
                    <button className="btn btn-secondary btn-sm" onClick ={() => this.props.onIncrement(this.props.id)}>
                    ...
                    <button className="btn btn-danger btn-sm" onClick= { () => this.props.onDelete}><i className="fa fa-trash" aria-hidden="true"></i></button>
                </div>
            </div>
         );
    }
