    ...
    render() { 
        return ( 
            <div className="row">
                ...
                <div className="col">
                    <button className="btn btn-secondary btn-sm"><i className="fa fa-plus" aria-hidden="true"></i></button>
                    <button className="btn btn-secondary btn-sm mr-2 ml-2"><i className="fa fa-minus" aria-hidden="true"></i></button>
